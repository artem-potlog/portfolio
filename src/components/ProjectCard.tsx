...
export default function ProjectCard({ item, onOpen }: Props) {
  ...
  return (
    <div
      ...
      className="group relative flex h-full cursor-pointer flex-col overflow-hidden rounded-2xl border border-line bg-ink-soft p-6 transition-all duration-500 hover:border-brass/30 hover:bg-panel sm:p-7"
    >
      {/* spotlight */}
      <div
